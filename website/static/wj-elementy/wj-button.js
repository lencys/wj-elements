...
import w, { event as s } from "./wj-element.js";
import "./wj-store.js";
const a = (o) => o === "false" || o === "null" || o === "NaN" || o === "undefined" || o === "0" ? !1 : !!o, j = `/*!
* direction.scss
...
class h extends w {
  ...
  set stopPropagation(t) {
    this.setAttribute("stop-propagation", a(t));
  }
  get stopPropagation() {
    return a(this.getAttribute("stop-propagation"));
  }
  ...
  afterDraw() {
    s.addListener(this, "click", "wj:button-click", null, { stopPropagation: this.stopPropagation }), s.addListener(this, "click", null, this.eventDialogOpen);
  }
  beforeDisconnect() {
