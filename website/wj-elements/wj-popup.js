...
import Lt, { event as q } from "./wj-element.js";
import "./wj-store.js";
...
function ut(t, e, n) {
  ...
  const s = et(e), r = rt(e), l = st(r), c = V(e), a = s === "y", h = o.x + o.width / 2 - i.width / 2, u = o.y + o.height / 2 - i.height / 2, d = o[l] / 2 - i[l] / 2;
  let f;
  switch (c) {
    case "top":
      f = {
...
async function gt(t, e) {
  ...
  const {
    ...
    altBoundary: d = !1,
    padding: f = 0
  } = J(e, t), p = mt(f), y = l[d ? u === "floating" ? "reference" : "floating" : u], g = tt(await s.getClippingRect({
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      const {
        ...
        flipAlignment: p = !0,
        ...m
      } = J(t, e), y = V(o), g = V(r) === r, x = await (l.isRTL == null ? void 0 : l.isRTL(c.floating)), b = u || (g || !p ? [Z(r)] : Wt(r));
      ...
      if (T = [...T, {
        ...
        let E = (M = T.filter((P) => P.overflows[0] <= 0).sort((P, j) => P.overflows[1] - j.overflows[1])[0]) == null ? void 0 : M.placement;
        if (!E)
          switch (d) {
            case "bestFit": {
              var Y;
              const P = (Y = T.map((j) => [j.placement, j.overflows.filter((F) => F > 0).reduce((F, Ct) => F + Ct, 0)]).sort((j, F) => j[1] - F[1])[0]) == null ? void 0 : Y[0];
              P && (E = P);
              break;
            }
...
async function Vt(t, e) {
  const {
    ...
    platform: o,
    elements: i
  } = t, s = await (o.isRTL == null ? void 0 : o.isRTL(i.floating)), r = V(n), l = _(n), c = et(n) === "y", a = ["left", "top"].includes(r) ? -1 : 1, h = s && c ? -1 : 1, u = J(e, t);
  let {
    mainAxis: d,
    crossAxis: f,
    alignmentAxis: p
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      const {
        ...
        ...l
      } = J(t, e), c = await gt(e, l), a = V(n), h = _(n), u = et(n) === "y", {
        width: d,
        height: f
      } = o.floating;
      let p, m;
...
function xt(t) {
  const e = $(t);
  return nt(e) ? t.ownerDocument ? t.ownerDocument.body : t.body : S(e) && K(e) ? e : xt(e);
}
function U(t, e) {
  var n;
  e === void 0 && (e = []);
  const o = xt(t), i = o === ((n = t.ownerDocument) == null ? void 0 : n.body), s = R(o);
  return i ? e.concat(s, s.visualViewport || [], K(o) ? o : [], s.frameElement ? U(s.frameElement) : []) : e.concat(o, U(o));
}
function vt(t) {
  const e = L(t);
...
function z(t, e, n, o) {
  ...
  if (s) {
    const d = R(s), f = o && D(o) ? R(o) : o;
    let p = d.frameElement;
    for (; p && o && f !== d; ) {
      const m = I(p), y = p.getBoundingClientRect(), g = L(p), x = y.left + (p.clientLeft + parseFloat(g.paddingLeft)) * m.x, b = y.top + (p.clientTop + parseFloat(g.paddingTop)) * m.y;
...
function qt(t) {
  ...
  const c = N(0);
  if ((i || !i && o !== "fixed") && ((B(n) !== "body" || K(s)) && (r = ot(n)), S(n))) {
    const a = z(n);
...
function bt(t) {
  return z(k(t)).left + ot(t).scrollLeft;
}
function Jt(t) {
  const e = k(t), n = ot(t), o = t.ownerDocument.body, i = C(e.scrollWidth, e.clientWidth, o.scrollWidth, o.clientWidth), s = C(e.scrollHeight, e.clientHeight, o.scrollHeight, o.clientHeight);
...
function Gt(t, e) {
  const n = z(t, !0, e === "fixed"), o = n.top + t.clientTop, i = n.left + t.clientLeft, s = S(t) ? I(t) : N(1), r = t.clientWidth * s.x, l = t.clientHeight * s.y, c = i * s.x, a = o * s.y;
  return {
    width: r,
    height: l,
    x: c,
...
function At(t, e) {
  const n = $(t);
  return n === e || !D(n) || nt(n) ? !1 : L(n).position === "fixed" || At(n, e);
}
function Qt(t, e) {
  const n = e.get(t);
  if (n)
    return n;
  let o = U(t).filter((l) => D(l) && B(l) !== "body"), i = null;
  const s = L(t).position === "fixed";
  let r = s ? $(t) : t;
  for (; D(r) && !nt(r); ) {
    const l = L(r), c = ct(r);
    !c && l.position === "fixed" && (i = null), (s ? !c && !i : !c && l.position === "static" && !!i && ["absolute", "fixed"].includes(i.position) || K(r) && !c && At(t, r)) ? o = o.filter((h) => h !== r) : i = l, r = $(r);
  }
  return e.set(t, o), o;
}
function Zt(t) {
...
function ee(t, e, n) {
  const o = S(e), i = k(e), s = n === "fixed", r = z(t, !0, s, e);
  let l = {
    scrollLeft: 0,
    scrollTop: 0
  };
...
class ae extends Lt {
  ...
  setAnchor() {
    ...
    q.addListener(this.anchorEl, "click", null, (n) => {
  ...
  reposition() {
    ...
    }), q.dispatchCustomEvent(this, "wj-popup:reposition", {
  ...
  show() {
    q.dispatchCustomEvent(this, "wj-popup:show"), this.native.classList.add("popup-active"), this.cleanup = re(this.anchorEl, this.native, () => {
      this.reposition();
    });
  }
  hide() {
    q.dispatchCustomEvent(this, "wj-popup:hide"), this.native.classList.remove("popup-active"), this.cleanup(), this.cleanup = void 0;
  }
  disconnectedCallback() {
    q.removeElement(this.anchorEl);
  }
}
