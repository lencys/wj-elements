...
---
import Props from '@ionic-internal/component-api/v1/datetime-button/props.md';
import Events from '@ionic-internal/component-api/v1/datetime-button/events.md';
import Methods from '@ionic-internal/component-api/v1/datetime-button/methods.md';
import Parts from '@ionic-internal/component-api/v1/datetime-button/parts.md';
import CustomProps from '@ionic-internal/component-api/v1/datetime-button/custom-props.md';
import Slots from '@ionic-internal/component-api/v1/datetime-button/slots.md';
...
import Basic from '@site/static/usage/v1/datetime-button/basic/index.md';
