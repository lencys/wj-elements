...
<wj-card href="../api/chip">
  ...
  <wj-card-content>
    <p>A chip is a universal element that is a small visual block containing various other elements such as avatars, text and icons.</p>
  </wj-card-content>
</wj-card>
</a>
...
<wj-card href="../api/dialog">
  <wj-card-header>
      ...
      <wj-card-title>Dialogue</wj-card-title>
  </wj-card-header>
  <wj-card-content>
