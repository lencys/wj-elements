...
The `wje-option` page was auto-generated to keep API documentation coverage in sync with the current component set.
Detailed usage and best-practice guidance will be expanded in the next content phase.


## When to use

Use `wje-option` when users need to enter values, choose options, or trigger form-related actions.
