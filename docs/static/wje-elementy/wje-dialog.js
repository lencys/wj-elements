...
class j extends v {
  ...
  draw(e, c, r) {
    ...
    d.setAttribute("part", "header"), d.classList.add("dialog-header"), this.hasAttributes("headline") && (d.innerHTML = `<span>${this.headline}</span>`), d.appendChild(i);
    ...
    return p.setAttribute("name", "footer"), l.appendChild(p), a.appendChild(d), a.appendChild(n), a.appendChild(l), s.appendChild(a), this.dialog = a, s;
  }
  afterDraw(e, c, r) {
    console.log("Dialog afterDraw", r), r.trigger && document.addEventListener(r.trigger, () => {
