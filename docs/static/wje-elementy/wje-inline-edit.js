...
class o extends l {
  ...
  draw(t, e, d) {
    ...
    return (
      ...
      this.notEditable ||
        ...
        i.appendChild(this.form)),
      i
    );
  }
  afterDraw(t, e, d) {
    this.notEditable ||
      (this.heading.addEventListener('click', (i) => {
  ...
  inputElement() {
    ...
    return (
      (t.type = 'text'),
      (t.placeholder = this.title),
      (t.value = this.title),
      t.classList.add('form-control', 'input-sm'),
      t
    );
  }
  save(t) {
