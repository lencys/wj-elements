...
class c extends p {
  ...
  draw(e, b, u) {
    ...
    r.classList.add('native-radio'),
      this.color && r.classList.add(this.color),
  ...
  afterDraw() {
    this.hasAttribute('disabled') ||
      (n.addListener(this, 'click', 'wje-radio:change'), n.addListener(this, 'click', 'wje-radio:input'));
  }
