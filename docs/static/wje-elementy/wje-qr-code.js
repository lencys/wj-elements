...
const de =
  '.container{display:flex;flex-direction:column;align-items:center;justify-content:center;position:relative;gap:.5rem;padding:.5rem}';
var ue =
  typeof globalThis < 'u'
    ? globalThis
    : typeof window < 'u'
...
(function (o, b) {
  (function (l, O) {
    ...
    function B(t, e) {
      ...
      return (
        typeof Object.create == 'function'
          ? (i = Object.create(t))
          : ((l.prototype = t), (i = new l()), (l.prototype = null)),
        e && k(!0, i, e),
        i
      );
    }
    function d(t, e, i, r) {
      var a = this;
      return (
        typeof t != 'string' && ((r = i), (i = e), (e = t), (t = null)),
        typeof e != 'function' &&
          ((r = i),
          (i = e),
          (e = function () {
    ...
    function k(t, e, i) {
      ...
      for (var r, a, x = 0, n = i.length; x < n; x++) {
        a = i[x];
        for (r in a) (!t || O.call(a, r)) && (e[r] = a[r]);
      }
    }
    var w = d;
    function h() {}
    ...
    var z = h,
        ...
        },
        {
          ...
          getOffset: function (t) {
            ...
            var r = this.getModuleSize(t),
              a = Math.floor((e.size - r * t.width) / 2);
            return Math.max(0, a);
          },
          /**
      ...
      c = u.extend(
        function (t) {
          ...
          for (
            ...
            (e = M.BLOCKS[r++]),
            (i = M.BLOCKS[r]),
            (r = e * (a + x) + x - 3 + (this._version <= 9)),
            !(n <= r));

          );
          (this._dataBlock = e), (this._eccBlock = i), (this._neccBlock1 = a), (this._neccBlock2 = x);
          var s = (this.width = 17 + 4 * this._version);
          (this.buffer = c._createArray(s * s)),
            (this._ecc = c._createArray(e + (e + i) * (a + x) + x)),
            (this._mask = c._createArray((s * (s + 1) + 1) / 2)),
            this._insertFinders(),
        ...
        },
        {
          ...
          _appendData: function (t, e, i, r) {
            ...
            for (x = 0; x < r; x++) f[i + x] = 0;
            for (x = 0; x < e; x++) {
              if (((a = p.LOG[f[t + x] ^ f[i]]), a !== 255))
                for (n = 1; n < r; n++) f[i + n - 1] = f[i + n] ^ p.EXPONENT[c._modN(a + s[r - n])];
              else for (n = i; n < i + r; n++) f[n] = f[n + 1];
          ...
          _appendEccToData: function () {
            var t,
              ...
              a = this._eccBlock;
            for (t = 0; t < this._neccBlock1; t++) this._appendData(e, i, r, a), (e += i), (r += a);
            for (t = 0; t < this._neccBlock2; t++) this._appendData(e, i + 1, r, a), (e += i + 1), (r += a);
          },
          _applyMask: function (t) {
            ...
            switch (t) {
              case 0:
                for (a = 0; a < n; a++)
                  for (r = 0; r < n; r++) !((r + a) & 1) && !this._isMasked(r, a) && (x[r + a * n] ^= 1);
                break;
              case 1:
                for (a = 0; a < n; a++)
                  for (r = 0; r < n; r++) !(a & 1) && !this._isMasked(r, a) && (x[r + a * n] ^= 1);
                break;
              case 2:
                for (a = 0; a < n; a++)
                  for (e = 0, r = 0; r < n; r++, e++)
              ...
              case 6:
                for (i = 0, a = 0; a < n; a++, i++)
                  for (i === 3 && (i = 0), e = 0, r = 0; r < n; r++, e++)
                    e === 3 && (e = 0),
                      !(((r & a & 1) + (e && e === i)) & 1) && !this._isMasked(r, a) && (x[r + a * n] ^= 1);
                break;
              case 7:
                for (i = 0, a = 0; a < n; a++, i++)
                  for (i === 3 && (i = 0), e = 0, r = 0; r < n; r++, e++)
                    e === 3 && (e = 0),
                      !(((e && e === i) + ((r + a) & 1)) & 1) && !this._isMasked(r, a) && (x[r + a * n] ^= 1);
                break;
            }
          },
            ...
            for (a = 0; a < f - 1; a++)
              for (r = 0; r < f - 1; r++)
                ((s[r + f * a] && s[r + 1 + f * a] && s[r + f * (a + 1)] && s[r + 1 + f * (a + 1)]) || // All background colour.
                  !(s[r + f * a] || s[r + 1 + f * a] || s[r + f * (a + 1)] || s[r + 1 + f * (a + 1)])) &&
                  (x += c.N2);
            var _ = 0;
            for (a = 0; a < f; a++) {
          ...
          _convertBitStream: function (t) {
            ...
            var x = (this._stringBuffer = r.slice()),
              n = this._calculateMaxLength();
            t >= n - 2 && ((t = n - 2), a > 9 && t--);
            var s = t;
            if (a > 9) {
              for (x[s + 2] = 0, x[s + 3] = 0; s--; ) (e = x[s]), (x[s + 3] |= 255 & (e << 4)), (x[s + 2] = e >> 4);
              (x[2] |= 255 & (t << 4)), (x[1] = t >> 4), (x[0] = 64 | (t >> 12));
            } else {
              for (x[s + 1] = 0, x[s + 2] = 0; s--; ) (e = x[s]), (x[s + 2] |= 255 & (e << 4)), (x[s + 1] = e >> 4);
              (x[1] |= 255 & (t << 4)), (x[0] = 64 | (t >> 4));
            }
            for (s = t + 3 - (a < 10); s < n; ) (x[s++] = 236), (x[s++] = 17);
          },
          _getBadness: function (t) {
            ...
            for (e = 3; e < t - 1; e += 2)
              r[e - 2] === r[e + 2] &&
                r[e + 2] === r[e - 1] &&
                r[e - 1] === r[e + 1] &&
                r[e - 1] * 3 === r[e] && // Background around the foreground pattern? Not part of the specs.
                (r[e - 3] === 0 || e + 3 > t || r[e - 3] * 3 >= r[e] * 4 || r[e + 3] * 3 >= r[e] * 4) &&
                (i += c.N3);
            return i;
          },
          _finish: function () {
            ...
            for (
              e = 0;
              e < 8 && (this._applyMask(e), (t = this._checkBadness()), t < r && ((r = t), (i = e)), i !== 7);
              e++
            )
          ...
          _interleaveBlocks: function () {
            var t,
              ...
              s = this._neccBlock1,
              f = this._neccBlock2,
              _ = this._stringBuffer;
            for (t = 0; t < i; t++) {
              for (e = 0; e < s; e++) r[x++] = _[t + e * i];
              for (e = 0; e < f; e++) r[x++] = _[s * i + t + e * (i + 1)];
            }
            for (e = 0; e < f; e++) r[x++] = _[s * i + t + e * (i + 1)];
            for (t = 0; t < a; t++) for (e = 0; e < s + f; e++) r[x++] = _[n + t + e * a];
          ...
          _insertAlignments: function () {
            ...
            if (r > 1)
              for (t = F.BLOCK[r], i = a - 7; ; ) {
                for (e = a - 7; e > t - 3 && (this._addAlignment(e, i), !(e < t)); ) e -= t;
                if (i <= t + 9) break;
          ...
          _insertFinders: function () {
            ...
            for (t = 0; t < 3; t++) {
              for (
                e = 0, r = 0, t === 1 && (e = x - 7), t === 2 && (r = x - 7), a[r + 3 + x * (e + 3)] = 1, i = 0;
                i < 6;
                i++
              )
                (a[r + i + x * e] = 1),
          ...
          _insertVersion: function () {
            ...
            if (x > 6)
              for (t = Q.BLOCK[x - 7], e = 17, i = 0; i < 6; i++)
                for (r = 0; r < 3; r++, e--)
                  1 & (e > 11 ? x >> (e - 12) : t >> e)
                    ? ((a[5 - i + n * (2 - r + n - 11)] = 1), (a[2 - r + n - 11 + n * (5 - i)] = 1))
                    : (this._setMask(5 - i, 2 - r + n - 11), this._setMask(2 - r + n - 11, 5 - i));
          },
        ...
        },
        {
          ...
          getAll: function (t) {
            var e,
              i = this.options,
              r = {};
            for (e in i) m.hasOwn(i, e) && (r[e] = g._get(i[e], t));
            return r;
          },
          /**
          ...
          init: function (t, e, i) {
            ...
            for (r in this.options)
              m.hasOwn(this.options, r) &&
                ((a = this.options[r]), g._set(a, a.defaultValue, e), g._createAccessor(a, e, i));
            this._setAll(t, e, !0);
          },
          /**
          ...
          _set: function (t, e, i, r) {
            ...
            if (!a) throw new Error('Invalid option: ' + t);
            if (!a.modifiable && !r) throw new Error('Option cannot be modified: ' + t);
            return g._set(a, e, i);
          },
          _setAll: function (t, e, i) {
            ...
            var r,
              a = !1;
            for (r in t) m.hasOwn(t, r) && this._set(r, t[r], e, i) && (a = !0);
            return a;
          },
        },
        {
          ...
          _set: function (t, e, i) {
            var r = '_' + t.name,
              a = i[r],
              x = t.transform(e ?? t.defaultValue);
            return (i[r] = x), x !== a;
          },
        }
      ),
      ...
      L = u.extend(
        function (t) {
          ...
          var e = A.get('element', this),
            i = S.getService('element'),
            r = e && i.isCanvas(e) ? e : i.createCanvas(),
            a = e && i.isImage(e) ? e : i.createImage();
...
class T extends le {
  ...
  afterDraw(l, O, E) {
    const B = this.shadowRoot.querySelector('canvas'),
      d = {};
    ['value', 'background', 'backgroundAlpha', 'foreground', 'foregroundAlpha', 'level', 'padding', 'size'].forEach(
      (w) => {
        const h = this.getAttribute(w);
        h !== null && (d[w] = h);
      }
    ),
      d.hasOwnProperty('value') || (d.value = 'empty value'),
      new _e({
        element: B,
        ...d,
      });
