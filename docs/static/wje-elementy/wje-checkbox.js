...
class p extends b {
  ...
  draw(e, k, u) {
    ...
    i.classList.add('native-checkbox'),
      this.variant === 'circle' && i.classList.add('checkbox-circle'),
      this.color && i.classList.add(this.color);
    let o = document.createElement('input');
    (o.type = 'checkbox'),
      (o.id = 'checkbox'),
      (o.name = this.name = 'checkbox'),
      (o.checked = this.hasAttribute('checked')),
      (o.disabled = this.hasAttribute('disabled')),
      (o.indeterminate = this.hasAttribute('indeterminate'));
