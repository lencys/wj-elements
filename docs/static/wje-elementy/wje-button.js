...
class d extends h {
  ...
  constructor() {
    ...
    s(this, 'toggleStates', () => {
      this.slotToggle
        .assignedNodes()
        .filter((l) => l.nodeType === Node.ELEMENT_NODE)
        .forEach((l) => {
  ...
  draw(o, l, m) {
    ...
    if (
      ...
      this.disabled && this.classList.add('wje-button-disabled'),
      this.variant && this.classList.add('wje-button-' + this.variant),
      this.hasAttribute('round') && this.classList.add('wje-button-round'),
      this.hasAttribute('circle') && this.classList.add('wje-button-circle'),
      this.outline && this.classList.add('wje-outline'),
      this.fill && this.classList.add('wje-button-' + this.fill),
      this.size && this.classList.add('wje-button-' + this.size),
      ...
      a.style.setProperty('--wje-icon-size', '14px'),
        a.setAttribute('slot', 'caret'),
        a.setAttribute('name', 'chevron-down'),
        this.appendChild(a);
    }
    if (this.active) {
    ...
    return (
      e.setAttribute('name', 'icon-only'),
      n.appendChild(e),
      (e = document.createElement('slot')),
      e.setAttribute('name', 'start'),
      n.appendChild(e),
      (e = document.createElement('slot')),
      n.appendChild(e),
      (e = document.createElement('slot')),
      e.setAttribute('name', 'end'),
      n.appendChild(e),
      (e = document.createElement('slot')),
      e.setAttribute('name', 'caret'),
      n.appendChild(e),
      (this.hasToggle = g.hasSlot(this, 'toggle')),
      this.hasToggle &&
        ((this.slotToggle = document.createElement('slot')),
        this.slotToggle.setAttribute('name', 'toggle'),
        n.appendChild(this.slotToggle)),
      c.appendChild(n),
      u.appendChild(c),
      u
    );
  ...
  afterDraw() {
    this.hasToggle &&
      ...
      i.addListener(this, 'click', 'wje-button:click', null, { stopPropagation: this.stopPropagation }),
      i.addListener(this, 'click', null, this.eventDialogOpen),
      this.hasToggle &&
        i.addListener(this, 'click', 'wje-button:toggle', this.toggleStates, { stopPropagation: this.stopPropagation });
  }
  /**
