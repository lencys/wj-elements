...
class p extends h {
  ...
  set stopPropagation(o) {
    this.setAttribute("stop-propagation", d(o));
  }
  get stopPropagation() {
    return d(this.getAttribute("stop-propagation"));
  }
  ...
  draw(o, a, v) {
    ...
    if (this.disabled && this.classList.add("wj-button-disabled"), this.variant && this.classList.add("wj-button-" + this.variant), this.round && this.classList.add("wj-button-round"), this.outline && this.classList.add("wj-outline"), this.fill && this.classList.add("wj-button-" + this.fill), this.size && this.classList.add("wj-button-" + this.size), this.hasAttribute("color") ? this.classList.add("wj-color-" + this.color, "wj-color") : this.classList.add("wj-color-default", "wj-color"), this.hasAttribute("caret") || this.hasAttribute("only-caret")) {
      ...
      l.style.setProperty("--wj-icon-size", "14px"), l.setAttribute("slot", "caret"), l.setAttribute("name", "chevron-down"), this.appendChild(l);
    }
    if (this.active) {
    ...
    return r.setAttribute("name", "icon-only"), n.appendChild(r), r = document.createElement("slot"), r.setAttribute("name", "start"), n.appendChild(r), r = document.createElement("slot"), n.appendChild(r), r = document.createElement("slot"), r.setAttribute("name", "end"), n.appendChild(r), r = document.createElement("slot"), r.setAttribute("name", "caret"), n.appendChild(r), console.log(w.hasSlot(this, "toggle")), w.hasSlot(this, "toggle") && (this.slotToggle = document.createElement("slot"), this.slotToggle.setAttribute("name", "toggle"), n.appendChild(this.slotToggle)), s.appendChild(n), u.appendChild(s), u;
  }
  afterDraw() {
    console.log(this.toggle), this.toggle === "on" ? this.slotToggle.assignedNodes()[0].classList.add("show") : this.slotToggle.assignedNodes()[1].classList.add("show"), i.addListener(this, "click", "wj:button-click", null, { stopPropagation: this.stopPropagation }), i.addListener(this, "click", null, this.eventDialogOpen), i.addListener(this, "click", "wj-button:toggle", this.toggleStates, { stopPropagation: this.stopPropagation });
  }
  beforeDisconnect() {
