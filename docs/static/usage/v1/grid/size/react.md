...
function Example() {
  return (
    <>
      <span>
        Slĺpec 2 má <strong>size</strong> <strong>"8"</strong>
      </span>
      <wje-grid>
        <wje-row>
          <wje-col>1</wje-col>
      ...
      <span>
        Stĺpce 3 & 4 majú <strong>size</strong> <strong>"3"</strong>
      </span>
      <wje-grid>
        <wje-row>
          <wje-col>1</wje-col>
      ...
      <span>
        Stĺpce 1 & 2 majú <strong>size</strong> nastavenú na <strong>"4"</strong>
      </span>
      <wje-grid>
        <wje-row>
