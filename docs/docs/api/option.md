...
Stránka pre `wje-option` bola automaticky doplnená, aby dokumentácia pokrývala aktuálnu verziu komponentov.
Detailné návody na použitie a odporúčania doplníme v ďalšej obsahovej fáze.


## Kedy použiť

Použite `wje-option`, keď používateľ zadáva hodnotu, vyberá možnosti alebo vykonáva akciu vo formulári.
