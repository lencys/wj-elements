...
title: "ion-segment"
---
import Props from '@ionic-internal/component-api/v1/segment/props.md';
import Events from '@ionic-internal/component-api/v1/segment/events.md';
import Methods from '@ionic-internal/component-api/v1/segment/methods.md';
import Parts from '@ionic-internal/component-api/v1/segment/parts.md';
import CustomProps from '@ionic-internal/component-api/v1/segment/custom-props.md';
import Slots from '@ionic-internal/component-api/v1/segment/slots.md';
...
import Basic from '@site/static/usage/v1/segment/basic/index.md';
...
import Scrollable from '@site/static/usage/v1/segment/scrollable/index.md';
...
import Toolbar from '@site/static/usage/v1/toolbar/segments/index.md';
...
import Colors from '@site/static/usage/v1/segment/theming/colors/index.md';

<Colors />

### CSS Custom Properties

import CSSProps from '@site/static/usage/v1/segment/theming/css-properties/index.md';
