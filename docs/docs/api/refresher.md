...
title: "ion-refresher"
---
import Props from '@ionic-internal/component-api/v1/refresher/props.md';
import Events from '@ionic-internal/component-api/v1/refresher/events.md';
import Methods from '@ionic-internal/component-api/v1/refresher/methods.md';
import Parts from '@ionic-internal/component-api/v1/refresher/parts.md';
import CustomProps from '@ionic-internal/component-api/v1/refresher/custom-props.md';
import Slots from '@ionic-internal/component-api/v1/refresher/slots.md';
...
import Basic from '@site/static/usage/v1/refresher/basic/index.md';
...
import PullProperties from '@site/static/usage/v1/refresher/pull-properties/index.md';
...
import CustomContent from '@site/static/usage/v1/refresher/custom-content/index.md';
...
import CustomScrollTarget from '@site/static/usage/v1/refresher/custom-scroll-target/index.md';
...
import Advanced from '@site/static/usage/v1/refresher/advanced/index.md';
