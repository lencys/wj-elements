...
title: "ion-nav"
---
import Props from '@ionic-internal/component-api/v1/nav/props.md';
import Events from '@ionic-internal/component-api/v1/nav/events.md';
import Methods from '@ionic-internal/component-api/v1/nav/methods.md';
import Parts from '@ionic-internal/component-api/v1/nav/parts.md';
import CustomProps from '@ionic-internal/component-api/v1/nav/custom-props.md';
import Slots from '@ionic-internal/component-api/v1/nav/slots.md';
...
import NavLinkExample from '@site/static/usage/v1/nav/nav-link/index.md';
