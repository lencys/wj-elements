...
import Header from '@site/static/usage/v1/header/basic/index.md';
...
import Footer from '@site/static/usage/v1/footer/basic/index.md';
...
import Tabs from '@site/static/usage/v1/tabs/router/index.md';
...
import Menu from '@site/static/usage/v1/menu/basic/index.md';
...
import SplitPane from '@site/static/usage/v1/split-pane/basic/index.md';
