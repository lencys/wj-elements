import { Module } from '../../plugins/tabulator/js/tabulator_esm.js?v=@@version@@';

class WjTableModules extends Module{
    ...
    loadPopup(e, component, contents, renderedCallback, position){
        ...
        popup.show(e.target || component.getElement(), position || "center");

        popup.hideOnBlur(() => {
            this.dispatchExternal("popupClosed", [component.getComponent(),popup]);
        });
...
WjTableModules.moduleName = "popup";

export default WjTableModules;
