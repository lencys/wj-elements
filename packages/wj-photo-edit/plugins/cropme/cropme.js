  ...
  function createRotationSlider() {
    if (this.properties.rotation_slider) {
      ...
      if (this.options.rotation.slider) {
        ...
        slider.style.backgroundSize = Number((slider.value - slider.min) * 100 / (slider.max - slider.min)) + '% 100%'
        ...
        // pridane pre potreby inicializacie slidera
        ...
        return new Promise(function (resolve) {
          _this.properties.image.onload = function () {
            ...
            if (self.options.zoom.slider) {
              ...
              properties.slider.dispatchEvent(new Event("change")); // spustame pre potrebyprvotnej inizializacie
            }

            if (self.options.rotation.slider) {
              properties.rotation_slider.value = deg;
              properties.rotation_slider.dispatchEvent(new Event("change")); // spustame pre potrebyprvotnej inizializacie
            }
