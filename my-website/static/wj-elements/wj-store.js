...
import { P as o, d as c } from "./default-store-actions-ff3e8b0b.js";
class l {
  constructor(r = {}) {
    h(this, "_state");
    h(this, "_reducer");
    ...
    this._isPause = !1, this._state = {}, this._reducer = function(s = {}, t) {
      return {};
    }, this.status = "resting", this.events = new o(), r != null && r.hasOwnProperty("reducer") && (this._reducer = r.reducer), this.refreshProxy(r == null ? void 0 : r.state);
  }
  /**
  ...
  unsubscribe(r) {
    console.log(this), delete this.events[r];
  }
  pause() {
  ...
  makeEveryArrayEntryAsStoreState(r, e = [], s = "id") {
    e.forEach((t) => {
      this.getState().hasOwnProperty(`${r}-${t[s]}`) ? this.dispatch(c.updateAction(`${r}-${t[s]}`)(t)) : this.define(`${r}-${t.id || t.source || t[s]}`, t, null, s);
    });
  }
  define(r, e, s, t = "id") {
