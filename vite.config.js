...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    build: {
      ...
      lib: {
        entry: {
          'animations': './packages/utils/animations.js',
          'base-path': './packages/utils/base-path.js',
          'date': './packages/utils/date.js',
          'element-utils': './packages/utils/element-utils.js',
          'event': './packages/utils/event.js',
          'localize': './packages/utils/localize.js',
          'permissions': './packages/utils/permissions.js',
          'universal-service': './packages/utils/universal-service.js',
          ...
          "pagination": "packages/wje-pagination/pagination.js",
        ...
        fileName: (format, name) => {
          const noPrefix = ['animations', 'base-path', 'date', 'element-utils', 'event', 'localize', 'permissions', 'universal-service', 'utils']

          if (noPrefix.some((prefix) => name === prefix)) return name + '.js';
          return 'wje-' + name + '.js';
        },
        formats: ['es'],
        publicDir: false,
